...
Constant CANTGO__TX   = "Main Systems says, ~There doesn't seem to a path that way Chrysilya.~";
...
[ LanguageLM n x1;
  ...
  Miscellany:
           ...
           {   1: "(considering the first sixteen objects only)^";
              ...
              10: "Main Systems asks, ~What was that last command?~";
              11: "[You can't ~undo~ what hasn't been done!]";
              12: "[Can't ~undo~ twice in succession. Sorry!]";
              13: "[Previous turn undone.]";
              14: "Main Systems says, ~Sorry Chysilya, I can't help with that one.~";
              15: "Main Systems says, ~Your welcome, Chysilya.~";
              16: "Main Systems says, ~I can only correct one word with the 'oops' command.~";
              17: "Main Systems says, ~There isn't enough light for the visual sub-systems to operate Chrysilya.~";
              18: print "yourself";
              19: "As good-looking as ever.";
              20: "To repeat a command like ~frog, jump~, just say
                   ~again~, not ~frog, again~.";
              21: "Main Systems says, ~You cannot repeat that command.~";
              22: "Main Systems says, ~What?~";
              ...
              27: "Main Systems says, ~I don't understand Chrysilya, could you rephrase the last command?~";
              28: print "I only understood you as far as wanting to ";
              29: "I didn't understand that number.";
              30: "Main Systems says, ~I don't see what you're refering to Chrysilya.~";
              ...
              38: #ifdef DIALECT_US;
                  "Main Systems says, ~Chrysilya, are you okay? I don't recognize that last command.~";
                  #ifnot;
                  "Main Systems says, ~Chrysilya, are you okay? I don't recognise that last command.~";
                  #endif;
              39: "Main Systems sighs, ~Do we need to attempt everything that pops into our synaptic loops?~";
  ...
  Yes, No:        "Main Systems says, ~Whatever. Please move on.~";
