...
!  and fresh input called for.  In three cases the oops word must be jiggled.
    ...
    if (etype==MULTI_PE)   L__M(##Miscellany, 47);
    if (etype==MMULTI_PE)  L__M(##Miscellany, 47);
    ...
    if (etype==NOTHING_PE) L__M(##Miscellany, 47);
...
[ StartDaemon obj i;
   ...
   if (obj provides daemon_start) obj.daemon_start();
];
...
[ StopDaemon obj i;
   ...
   .FoundTSlot4;
   the_timers-->i=0;
   if (obj provides daemon_stop) obj.daemon_stop();
];
