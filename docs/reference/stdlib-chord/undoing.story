## ========================================================================
## REFERENCE ONLY — generated Chord-form rendering of `if.action.undoing`.
## This is NOT the implementation. The real action is TypeScript in
## packages/stdlib/src/actions/standard/undoing/. Do not edit — regenerate
...
story "Standard action: undoing" by "Sharpee (generated)"
  id: stdlib-chord-undoing
  version: 1.0.0
  reference-only: true

## Action  : if.action.undoing
## Group   : meta
## Verbs   : undo
