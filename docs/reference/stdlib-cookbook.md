# The Sharpee Standard Library — Cookbook
...
> `docs/work/stdlib-cookbook/fixtures/`, and every transcript line is
> genuine engine output, replayed on every run of
> `docs/work/stdlib-cookbook/verify.mjs` — compile with
...
- **`stdlib-reference.md`** — the full catalog this cookbook indexes:
...
- **`docs/work/stdlib-cookbook/`** — the fixtures and the
