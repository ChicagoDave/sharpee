Version 4 of Transit System by Emily Short begins here.
...
Rule for setting in motion a functional relatively-scheduled train-car (called relevant car) (this is the starting relatively-scheduled cars rule):
	...
	if the stop number of the relevant car is greater than the number of rows in the t-schedule of the relevant car, change the stop number of the relevant car to 1;
	let N be the stop number of the relevant car;
	choose row N in the t-schedule of the relevant car;
	change the next-arrival of the relevant car to the time of day plus the transit time entry;
	change the next stop of the relevant car to the destination entry;
...
Rule for setting in motion a functional absolutely-scheduled train-car (called relevant car) (this is the starting absolutely-scheduled cars rule):
	...
	otherwise:
		let N be the stop number of the relevant car;
		choose row N in the t-schedule of the relevant car;
		change the next-arrival of the relevant car to the transit time entry minus one minute;
		change the next stop of the relevant car to the destination entry;
		remove the relevant car from play.
...
Rule for stopping at station a functional train-car (called relevant car) (this is the stopping cars rule):
	...
	change the next-departure of the relevant car to the time of day plus the waiting duration of the relevant car;
