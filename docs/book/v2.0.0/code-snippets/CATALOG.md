...
| 03 | `03-creating-the-player.ts` | Creating the player | typescript | author | 107 |
| 04 | `04-containertrait.reference.ts` | Creating the player | typescript | reference — `ContainerTrait` | 134 |
| 05 | `05-building-the-world.ts` | Building the world | typescript | author | 151 |
| 06 | `06-exposing-the-story.ts` | Exposing the story | typescript | author | 213 |
...
| 03 | `03-getting-a-trait-back-with-get.ts` | Getting a trait back with `.get()` | typescript | author | 60 |
| 04 | `04-getting-a-trait-back-with-get.ts` | Getting a trait back with `.get()` | typescript | author | 68 |
| 05 | `05-putting-it-together.ts` | Putting it together | typescript | author | 80 |
| 06 | `06-putting-it-together.ts` | Putting it together | typescript | author | 92 |
...
| 02 | `02-entitytype-scenery-makes-a-thing-fixed.ts` | EntityType.SCENERY makes a thing fixed | typescript | author | 44 |
| 03 | `03-aliases-make-objects-findable.ts` | Aliases make objects findable | typescript | author | 91 |
| 04 | `04-putting-it-together.ts` | Putting it together | typescript | author | 149 |
...
| 02 | `02-portable-vs-fixed-containers.ts` | Portable vs fixed containers | typescript | author | 66 |
| 03 | `03-supportertrait.ts` | SupporterTrait | typescript | author | 88 |
| 04 | `04-capacity-limits.ts` | Capacity limits | typescript | author | 111 |
...
| 03 | `03-lockabletrait.ts` | LockableTrait | typescript | author | 72 |
| 04 | `04-doortrait-and-the-exit-via-property.ts` | DoorTrait and the exit `via` property | typescript | author | 110 |
| 05 | `05-doortrait-and-the-exit-via-property.ts` | DoorTrait and the exit `via` property | typescript | author | 121 |
| 06 | `06-wiring-it-all-together.ts` | Wiring it all together | typescript | author | 160 |
| 07 | `07-wiring-it-all-together.ts` | Wiring it all together | typescript | author | 170 |
...
| 05 | `05-other-light-source-patterns.ts` | Other light-source patterns | typescript | author | 100 |
| 06 | `06-other-light-source-patterns.ts` | Other light-source patterns | typescript | author | 106 |
| 07 | `07-other-light-source-patterns.ts` | Other light-source patterns | typescript | author | 118 |
| 08 | `08-wiring-it-into-the-zoo.ts` | Wiring it into the zoo | typescript | author | 134 |
| 09 | `09-wiring-it-into-the-zoo.ts` | Wiring it into the zoo | typescript | author | 142 |
...
| 03 | `03-reading-the-event-data.ts` | Reading the event data | typescript | author | 92 |
| 04 | `04-setting-up-the-gift-shop-the-press-and-remembering.ts` | Setting up: the gift shop, the press, and remembering IDs | typescript | author | 111 |
| 05 | `05-setting-up-the-gift-shop-the-press-and-remembering.ts` | Setting up: the gift shop, the press, and remembering IDs | typescript | author | 132 |
| 06 | `06-setting-up-the-gift-shop-the-press-and-remembering.ts` | Setting up: the gift shop, the press, and remembering IDs | typescript | author | 178 |
| 07 | `07-reaction-pattern-the-goats-eat-the-feed.ts` | Reaction pattern: the goats eat the feed | typescript | author | 190 |
| 08 | `08-transformation-pattern-put-a-in-get-b-out.ts` | Transformation pattern: put A in, get B out | typescript | author | 234 |
...
| 03 | `03-defining-the-behavior.ts` | Defining the behavior | typescript | author | 75 |
| 04 | `04-putting-the-pair-to-work.ts` | Putting the pair to work | typescript | author | 108 |
...
| 03 | `03-prepositions-and-two-slots.ts` | Prepositions and two slots | typescript | author | 76 |
| 04 | `04-constraining-a-slot.ts` | Constraining a slot | typescript | author | 98 |
...
| 02 | `02-querying-a-scene.ts` | Querying a scene | typescript | author | 49 |
| 03 | `03-reacting-to-transitions.ts` | Reacting to transitions | typescript | author | 70 |
| 04 | `04-reacting-to-transitions.ts` | Reacting to transitions | typescript | author | 84 |
| 05 | `05-common-shapes.ts` | Common shapes | typescript | author | 109 |
...
| 02 | `02-how-the-scheduler-ticks.ts` | How the scheduler ticks | typescript | author | 46 |
| 03 | `03-daemons-run-every-turn.ts` | Daemons: run every turn | typescript | author | 67 |
| 04 | `04-conditional-daemons-react-to-state.ts` | Conditional daemons: react to state | typescript | author | 124 |
| 05 | `05-fuses-count-down-and-fire.ts` | Fuses: count down and fire | typescript | author | 172 |
| 06 | `06-giving-the-announcements-their-words.ts` | Giving the announcements their words | typescript | author | 208 |
...
| 02 | `02-defining-the-scoring-table.ts` | Defining the scoring table | typescript | author | 45 |
| 03 | `03-defining-the-scoring-table.ts` | Defining the scoring table | typescript | author | 92 |
| 04 | `04-awarding-points-as-the-player-plays.ts` | Awarding points as the player plays | typescript | author | 115 |
...
| 02 | `02-the-index-wires-it-together.ts` | The index wires it together | typescript | author | 85 |
...
| 02 | `02-the-one-thing-you-must-save-yourself.ts` | The one thing you must save yourself | typescript | author | 49 |
...
| 02 | `02-adding-the-browser-client.sh` | Adding the browser client | bash | author | 35 |
| 03 | `03-hosting-it.sh` | Hosting it | bash | author | 51 |
