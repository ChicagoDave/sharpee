# Em-dash review — Chapter 16: Custom Traits & Behaviors

### 1. Chapter intro paragraph (line 3) — prose paragraph
OLD:
...
### 2. "Which tool, when?" intro paragraph (line 123) — prose paragraph
OLD:
