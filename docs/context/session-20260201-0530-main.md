...
### 10. Browser Client No-Server Instructions

**Updated quick-start documentation to clarify browser client usage:**

**Modified file:**
- `website/src/pages/docs/getting-started/quick-start.mdx`

**Change:**
- Replaced suggestion to use `npx serve dist/web` with simpler "open `dist/web/index.html` in your browser"
- Removed unnecessary server dependency (browser client is static HTML)
- Clearer instructions for beginners (no need to understand static file servers)

**Rationale:**
- Browser client works perfectly as local file (no CORS issues)
- Reduces friction for first-time users
- Eliminates `serve` as a dependency
- More direct path to seeing results

### 11. Website Footer Copyright

**Updated website footer with proper copyright and license:**
...
<!-- Before -->
<footer>
  <p>Sharpee — Interactive Fiction Engine for TypeScript</p>
</footer>

<!-- After -->
<footer>
  <p>Copyright {new Date().getFullYear()} David Cornelson — MIT License</p>
</footer>
```

**Features:**
- Auto-generates current year dynamically
- Proper copyright attribution to author
...
- `website/src/pages/docs/getting-started/quick-start.mdx` - build command, no-server instructions
...
- `website/src/layouts/BaseLayout.astro` - copyright footer
...
- `03cb6e2` - Browser client no-server instructions
- `23698d0` - Website footer copyright update
