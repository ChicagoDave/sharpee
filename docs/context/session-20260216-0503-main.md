...
Commands `burn wire` and `wait` (×5) complete without triggering the brick explosion sequence. The FUSIN daemon (2-turn countdown) appears to not be initializing or firing.
