...
> **D3 extended** by [ADR-300 D6/D12](adr-300-addressable-channels-and-canonical-transcript.md) (2026-08-04): the banner now has its own channel alongside the prologue, so the opening is two addressable channels rather than one channel plus prose on `main`.
