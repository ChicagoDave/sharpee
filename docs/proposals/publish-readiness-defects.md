# Proposal: Publish-readiness defects — what gates a formal Sharpee 5.3.0 + Chord Writer publish
...
- **Status**: DONE (2026-09-03, session effb6f — plan Phase 9; #318 closed; ADR-225 amendment DRAFT; the Secret Letter two-input pin waits on P-21); was PLANNED (docs/work/publish-readiness/plan.md, 2026-09-03; was ACCEPTED (David, 2026-09-03, session 639650 — "fix the proposal", per the review's recommendation))
...
- **Status**: DONE (2026-09-03, session effb6f — plan Phase 12; #245 closed); was PLANNED (docs/work/publish-readiness/plan.md, 2026-09-03; was ACCEPTED (David, 2026-09-03, session b6d0a8))
...
- **Done when**: `./repokit test:npm tutorials/familyzoo/v2.0.0` type-checks and its transcripts pass against 5.3.0; v1.5.0 is either migrated or retired with a note.
- **Status**: CARRIED FORWARD as GH #224 (2026-09-08, session 4a2d5f — the plan closed DONE by David's disposition; Phase 14 had deferred this item to David on 2026-09-03 with three options recorded there, and #224 stays open); was PLANNED (docs/work/publish-readiness/plan.md, 2026-09-03); was ACCEPTED (David, 2026-09-03, session b6d0a8)
...
- **Status**: CARRIED FORWARD as GH #387 (2026-09-08, session 4a2d5f — the plan closed DONE by David's disposition with this item unrun); was PLANNED (docs/work/publish-readiness/plan.md, 2026-09-03); was ACCEPTED (David, 2026-09-03, session b6d0a8)

### P-44: The publish itself — Sharpee 5.3.0 and Chord Writer together, against a frozen language
...
- **Done when**: (1) a language freeze is declared for the run — no grammar or IR change *outside this proposal's own items* lands between P-1's first fix and the publish, and the plan records the date after which the proposal's own language-touching items are also done (its Phase 9, the last phase that can touch Chord grammar or IR), both as dated lines in this proposal (reworded 2026-09-03, session 639650, `plan-review` CONTRADICTION — as first written the clause forbade the proposal's own fixes); (2) `@sharpee/*@5.3.0` is on npm via the workflow with `git diff --exit-code` clean after stamping; (3) Chord Writer's next version ships as signed, notarized DMGs for both architectures, its status bar naming Sharpee 5.3.0 and the Chord version; (4) sharpee.net's install page names the published versions; (5) P-43's proof was run against the published artifacts, not the repo.
...
- **Freeze declared (2026-09-03, session effb6f — plan Phase 9)**: Chord grammar and IR are frozen from this date until the P-44 publish, with one named carve-out — ADR-267 Amendment 1's `only while <condition>` (P-21, plan Phase 8), a proposal item that was gated on David's acceptance when Phase 9 ran; if accepted it lands before the publish and is the last grammar motion, if not the freeze stands as declared. ADR-331's rotation, if it goes core, lands after the publish. Everything since Phase 2 has been this proposal's own items (P-1's `, one-way`, P-6's `bare` hint, P-19's two standard shapes).
- **Status**: DONE for items (1)–(4) (2026-09-04, plan Phase 18: Sharpee 5.3.0 on npm, Chord Writer 1.4.0 notarized and live, install page updated); item (5) CARRIED FORWARD as GH #387 (2026-09-08, session 4a2d5f — the plan closed DONE by David's disposition); was PLANNED (docs/work/publish-readiness/plan.md, 2026-09-03); was ACCEPTED (David, 2026-09-03, session b6d0a8)
