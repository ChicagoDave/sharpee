#!/usr/bin/env node
/**
 * verify.mjs — runtime verification harness for the stdlib phrasebook
 * (docs/reference/stdlib-phrasebook.md).
 *
 * Purpose: prove every worked example in the phrasebook is genuine engine
 ...
 *
 * Owner context: docs tooling (stdlib-phrasebook work target); reads built
