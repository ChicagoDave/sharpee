#!/usr/bin/env node
/**
 * render-site.mjs — render docs/reference/stdlib-cookbook.md into
 * site/stdlib-cookbook.html, in the site's hand-written HTML conventions.
 *
 ...
 *
 * Public interface: `node render-site.mjs` — writes site/stdlib-cookbook.html
 * and prints the byte count. Owner context: docs tooling (stdlib-cookbook
...
const outPath = path.join(repoRoot, 'site', 'stdlib-cookbook.html');
