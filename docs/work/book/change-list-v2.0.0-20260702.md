...
| **Book-wide sweeps** | (a) `tutorials/familyzoo/src/` paths → `v2.0.0/src/`; (b) "v17/v18" naming → chapter-snapshot names; (c) pre-ADR-158 article-less transcript quotes | multiple |
...
**Clean chapters** (verified, no findings): preface, introduction, ch2, ch4, ch7, ch8,
...
**31-building-and-publishing.md** — CLEAN (repokit correctly absent; devkit flow verified).
