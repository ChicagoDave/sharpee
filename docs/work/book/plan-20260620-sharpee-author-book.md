...
- E — Grammar reference — **done** (added 2026-06-21), exhaustive (118 core grammar rules: pattern,
  action, priority, trait constraint) + a pattern-syntax/priority primer. Extracted by feeding a
  recording-mock `GrammarBuilder` to `parser-en-us`'s `defineGrammar`.
