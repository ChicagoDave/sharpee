  ...
  initializeWorld(world: WorldModel): void {
    ...
    pettingZoo.add(new IdentityTrait({
      ...
      description:
        ...
        'Pygmy goats trot around nibbling at visitors\' ' +
        'shoelaces{snippet:rabbits}. A feed dispenser is mounted on a ' +
        'post near the entrance. The main path is back to the west.',
