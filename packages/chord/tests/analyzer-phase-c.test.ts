...
describe('trait states: cross-trait resolution and the D8 collision gate', () => {
  it('two composed traits declaring the same state collide', () => {
    ...
    expect(errors[0].span.line).toBe(19);
