/**
 * Tests for `handleRoomDescription` — ported from text-service.
 *
 * Verifies ADR-107 dual-mode (messageId vs literal text), the verbose
 * flag for room name, and fallback chains.
 *
