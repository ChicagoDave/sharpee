 ...
 * Dungeo) is a separate package and stays text; it owns the assertion core
 * both worlds evaluate their claims with (ADR-340), which this package
 * imports and never copies.
 *
...
// Channel assertions over structured values (ADR-300 D13, D14) — the
// assertion core's, re-exported so this package's consumers keep their
// imports (ADR-340 D1/D5)
export {
  resolveChannelPath,
