 ...
 *
 * Covers **AC-8** — renaming updates the transcript and every child's
 * `continues:` together; renaming to a stem already taken in that story
...
describe('renameTranscript (ADR-302 D14, AC-8)', () => {
  it('AC-8 — the transcript and its children\'s pointers move together', () => {
    transcript('doormat', '');
  ...
  it('works for a childless transcript', () => {
    transcript('lonely', '');
