...
export const switchingOnLanguage = {
  ...
  messages: {
    ...
    'not_switchable': "{capitalize the target} isn't something {you} can switch on.",
    'already_on': "{capitalize the target} {verb:is target} already on.",
    'no_power': "{capitalize the target} {verb:has target} no power source.",

    // Success messages
    'switched_on': "{You} {switch} on {the target}.",
    'light_on': "{You} {switch} on {the target}, illuminating the area.",
    'device_humming': "{capitalize the target} hums to life.",
    'temporary_activation': "{capitalize the target} switches on temporarily.",
    'with_sound': "{You} {switch} on {the target}. {sound}",
    'door_opens': "{capitalize the target} switches on and opens.",
    'illuminates_darkness': "{capitalize the target} switches on, banishing the darkness."
  },
