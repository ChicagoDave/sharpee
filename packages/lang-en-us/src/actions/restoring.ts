...
export const restoringLanguage = {
  ...
  messages: {
    ...
    'game_loaded': "Game loaded from '{verbatim:saveName}'.",
    'restore_successful': "{Your} saved game has been restored successfully.",
    'welcome_back': "Welcome back! Game restored from {verbatim:saveName}.",

    // Restore details
    'restore_details': "Restored: {verbatim:saveName}\nScore: {score}\nMoves: {moves}",
    'quick_restore': "Quick restore completed.",
    'resuming_game': "Resuming {your} adventure...",

    // Error messages
    'restore_failed': "Failed to restore game.",
    'save_not_found': "No save named '{verbatim:saveName}' was found.",
    'no_saves': "No saved games found.",
    'corrupt_save': "The save file '{verbatim:saveName}' appears to be corrupted.",
    ...
    'confirm_restore': "Restore game from '{verbatim:saveName}'? Current progress will be lost.",
