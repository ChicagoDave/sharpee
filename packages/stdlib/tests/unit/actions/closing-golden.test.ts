...
describe('closingAction (Golden Pattern)', () => {
  describe('Three-Phase Pattern Compliance', () => {
    test('should have required methods for three-phase pattern', () => {
      expect(closingAction.validate).toBeDefined();
      expect(closingAction.execute).toBeDefined();
      expect(closingAction.report).toBeDefined();
    });
  ...
  describe('Precondition Checks', () => {
    ...
    test('should fail when target is not closable', () => {
      ...
      expectEvent(events, 'if.event.close_blocked', {
        ...
        params: expect.objectContaining({ item: expect.objectContaining({ name: 'red ball' }) })
      });
    });
    ...
    test('should fail when already closed', () => {
      ...
      expectEvent(events, 'if.event.close_blocked', {
        ...
        params: expect.objectContaining({ item: expect.objectContaining({ name: 'wooden box' }) })
      });
    });
  });
  ...
  describe('Successful Closing', () => {
    test('should close an open container', () => {
      ...
      expectEvent(events, 'if.event.closed', {
        ...
        params: { item: expect.objectContaining({ name: 'wooden box' }) },
        isContainer: true,
        isDoor: false,
        isSupporter: false,
        hasContents: false,
    ...
    test('should handle close requirements', () => {
      ...
      expectEvent(events, 'if.event.close_blocked', {
        ...
        params: expect.objectContaining({
          item: expect.objectContaining({ name: 'treasure chest' }),
