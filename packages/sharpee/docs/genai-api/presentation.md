...
import { createInfoChannelRenderer, createIfidChannelRenderer, createPrologueChannelRenderer } from './info.js';
 ...
 */
export declare function joinMainEntries(entries: unknown): string;
```
