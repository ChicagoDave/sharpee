...
declare global {
    interface Window {
        ...
        webkit?: {
            messageHandlers?: Record<string, HostChannel | undefined>;
        };
    }
}
/**
 ...
 */
export declare function hostChannel(channel: string): HostChannel | null;
/**
 ...
 */
export declare function hostChannelActive(channel: string): boolean;
/**
 ...
 */
export declare function postToHost(channel: string, body: unknown): void;
```
