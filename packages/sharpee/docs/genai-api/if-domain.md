...
export declare const IFEvents: {
    ...
    readonly BAND_CROSSED: "if.event.band_crossed";
};
 ...
 */
export declare const PREFERRED_LAYOUT_CHANNEL = "preferred-layout";
/**
 ...
 */
export declare const PROSE_CHANNEL_IDS: readonly ["room-name", "room-description", "room-contents", "action-result", "action-blocked", "error", "game-message"];
