 ...
 */
export declare function consultDialogue(context: ActionContext, call: (extension: DialogueExtension) => DialogueResult): DialogueOutcome | undefined;
/**
 ...
 */
export declare function dialogueMessageId(outcome: DialogueOutcome | undefined, fallback: string): string;
/**
 ...
 */
export declare function dialogueParams(defaults: Record<string, unknown>, outcome: DialogueOutcome | undefined): Record<string, unknown>;
```
