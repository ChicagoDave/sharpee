...
Fernhill's test tree runs the whole game text-only, including a
media-degrade branch asserting every media beat's prose shows and
...
fetching, the clock panel updating. Test the degradation in the text
run; trust the browser only after you've seen it.
