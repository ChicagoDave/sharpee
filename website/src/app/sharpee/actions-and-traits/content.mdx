...
- **World-mutating** — taking, dropping, opening, closing, going,
  entering, exiting, putting, inserting, giving, wearing, removing,
  eating, drinking, pushing, pulling, switching, locking, unlocking.
- **Query** — examining, looking, inventory: read state, mutate
  nothing.
- **Meta** — about, help, save, restore, quit: signals to the platform
