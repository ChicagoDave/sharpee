...
- Where an example carries a custom refusal on a *standard* action, its
  ...
  `define action` (see turning, [§6](/chord/phrasebook/devices-and-tools)) take short keys as they always have.

## What this document leans on

- **[The standard library reference](/chord/stdlib)** — the full catalog this phrasebook indexes:
...
- [Manipulation](/chord/phrasebook/manipulation)
- [Movement](/chord/phrasebook/movement)
- [Containers & locks](/chord/phrasebook/containers-and-locks)
- [Wearing](/chord/phrasebook/wearing)
- [Senses](/chord/phrasebook/senses)
- [Devices & tools](/chord/phrasebook/devices-and-tools)
- [Social](/chord/phrasebook/social)
- [Meta](/chord/phrasebook/meta)
