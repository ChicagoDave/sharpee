...
metadata. For a Chord story, that is simply the header: `title:`,
`authors:`, `story-version:` and `description:` flow straight through
(the platform materializes them into the story-info trait). A TypeScript story can add
