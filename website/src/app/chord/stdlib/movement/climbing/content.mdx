...
Interceptors: `after the player climbing` on the target, the pear tree's
...
destination room; put an `after the player climbing` clause on the cliff if you
