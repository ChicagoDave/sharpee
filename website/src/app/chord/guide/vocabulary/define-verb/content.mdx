...
routes through `smell`. This is verb *vocabulary* only: these are
aliases onto patterns the platform already understands. To define a genuinely new
action with its own grammar and behavior, use `define action`.
