...
`import "voices/winter"` (top level) splices in a file of your own
`define phrasebook` blocks — the file on disk is `voices/winter.chord`,
and its books take their arbitration position at the import line. A
phrasebook file is just one kind of fragment: `import` pulls in any
