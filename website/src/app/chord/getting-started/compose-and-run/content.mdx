...
`--check` runs every load-time gate and emits nothing — the fast
CI answer to "does my story still compile?". With `-o` it writes the
compiled story IR as JSON:
...
[people and pronouns](/chord/language/people).
