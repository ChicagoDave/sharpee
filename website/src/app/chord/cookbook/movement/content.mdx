These actions get an actor from place to place. Full entries live in [the
standard library reference](/chord/stdlib/movement); hiding is covered in
[the NPCs reference](/chord/stdlib/npcs).
