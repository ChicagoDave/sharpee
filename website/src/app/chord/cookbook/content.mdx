...
not fixed text; [the reference's §1.4](/chord/stdlib) explains how a story retargets
...
- Where an example carries a custom refusal on a *standard* action, its
  ...
  `define action` (see turning, [§6](/chord/cookbook/devices-and-tools)) take short keys as they always have.

## What this document leans on

- **[The standard library reference](/chord/stdlib)** — the full catalog this cookbook indexes:
  check order, success keys, events, traits, and the honest platform
  notes.
- **[the Author Guide](/chord/guide/reading)** — the `.story` language the "author writes"
