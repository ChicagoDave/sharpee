    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Manipulation', href: '/chord/stdlib/manipulation' },
          { title: 'Movement', href: '/chord/stdlib/movement' },
          { title: 'Containers & openables', href: '/chord/stdlib/containers' },
          { title: 'Wearing', href: '/chord/stdlib/wearing' },
          { title: 'Senses & examination', href: '/chord/stdlib/senses' },
          { title: 'Devices', href: '/chord/stdlib/devices' },
          { title: 'NPCs & conversation', href: '/chord/stdlib/npcs' },
          { title: 'Death', href: '/chord/stdlib/death' },
          { title: 'Meta & system', href: '/chord/stdlib/meta' },
          { title: 'Traits catalog', href: '/chord/stdlib/traits' },
          { title: 'Plugins & daemons', href: '/chord/stdlib/plugins' },
        ],
      },
      {
        title: 'Reference',
