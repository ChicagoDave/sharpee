...
These actions have no standard semantics — the target entity's trait determines what happens. See [Capability Dispatch](/docs/developer-guide/project-structure/) for details.
