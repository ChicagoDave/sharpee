...
table.add(new SupporterTrait({ capacity: { maxItems: 10, maxWeight: 50 } }));
...
apple.add(new EdibleTrait({ nutrition: 10, servings: 1 }));
```
...
| `EdibleTrait` | Can be eaten | `nutrition`, `servings` |
