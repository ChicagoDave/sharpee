...
│   ├── text-service/             # Output rendering pipeline
│   ├── text-blocks/              # Text block processing
│   ├── text-service-browser/     # Browser-specific text rendering
│   ├── text-service-template/    # Text service template
│   ├── if-domain/                # IF domain types
│   ├── if-services/              # IF service interfaces
│   ├── helpers/                  # Fluent entity builders
│   ├── bridge/                   # Engine-to-client bridge
│   ├── character/                # Character/NPC personality system
│   ├── media/                    # Audio events and sound design
│   ├── runtime/                  # Runtime orchestration
│   ├── client-react/             # React client components
│   ├── map-editor/               # Visual map editor
...
│   ├── zifmia/                   # Zifmia/Tauri desktop client
│   ├── extensions/
│   │   ├── basic-combat/         # Combat system extension
│   │   ├── conversation/         # Conversation system extension
│   │   └── testing/              # Test utilities
│   ├── platforms/
│   │   ├── browser-en-us/        # Browser platform (English)
│   │   ├── cli-en-us/            # CLI platform (English)
│   │   └── test/                 # Test platform
...
│   ├── thealderman/              # Murder mystery — character package reference
│   ├── cloak-of-darkness/        # Classic IF benchmark
│   ├── concealment-test/         # Concealment system test story
│   ├── armoured/                 # Armoured story
│   └── secretletter2025/         # Secret Letter story
├── tutorials/                    # Tutorial story projects
│   └── familyzoo/                # Family Zoo tutorial (split by platform line)
│       ├── v1.5.0/               #   frozen 1.x edition (pins ^1.5)
│       └── v2.0.0/               #   Phrase Algebra edition (pins ^2.0)
